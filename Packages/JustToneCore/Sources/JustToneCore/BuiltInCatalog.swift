...
public enum BuiltInCatalog {
    ...
    private static func model(_ slug: String, _ name: String, _ cents: [Double], _ limitations: String) -> CatalogTuningSystem {
        ...
        return try! CatalogTuningSystem(
            id: "org.justtone.tuning.\(slug)", name: name, alternateNames: [], classification: .tuningSystem,
    ...
    private static func template(_ slug: String, _ name: String, _ instrument: String, _ pitches: String, offset: Int = 0, editable: Bool = false) -> CatalogProfileTemplate {
        ...
        let id = "org.justtone.profile.\(slug)"
        return CatalogProfileTemplate(
            id: id,
            profile: try! TuningProfile(id: UUID(uuidString: "A4F54B8A-4100-4400-8000-\(String(format: "%012llX", profileTemplatesSeed(slug) & 0xFFFFFFFFFFFF))")!, name: name, instrument: instrument, tuningSystemID: "org.justtone.tuning.twelve-tone-equal", entries: entries, preferredTimbreID: "sine", soundingSemitoneOffset: offset),
