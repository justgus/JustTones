...
**Status:** Active — SP-025 is the sole active Sprint.
...
The delivery Sprints are sequential; only SP-025 is active.

| Sprint | Status | Governing task | Outcome |
| --- | --- | --- | --- |
| SP-025 — Custom Tuning-System Authoring | Active | T-0035 | iPhone authoring for persisted custom systems with all approved degree representations. |
| SP-026 — Import Review and Conflict Resolution | Backlog | T-0036 | Safe document selection, preview, and conflict-resolution surfaces over the validated parser. |
| SP-027 — Portable Export and Sharing | Backlog | T-0037 | System Share Sheet export and verified clean-library round trips. |
